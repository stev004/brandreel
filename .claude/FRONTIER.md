...
- Gates: typecheck 0, engine 32 tests, bin 85 tests, CI green. workspace/regulate-sigh is the first brief-driven video: passes all 12 lint rules, first model attempt.
...
Steven's KEEP/TWEAK/KILL on regulate-sigh first. Then: real glyph measurement; M3 assets + Broll; CC0 music fetcher; pin Remotion.
