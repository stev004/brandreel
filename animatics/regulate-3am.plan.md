...
**Status: KEEP (Steven, 2026-09-13, rev5d) - "it's so close, keep it." The animatic is frozen as the porting contract; no further animatic iteration. Next: Codex port brief via /dev-delegate (new `exhale` beat kind; scene durations 6.5 / 10.6 / 2.5 + the 1000ms close hold for the 15s lint floor is no longer needed at 19.6s).**
