...
## Waiting on Steven
0. **KEEP/TWEAK/KILL on workspace/regulate-sigh** (review.md; render is gitignored, rerun `node bin/reel.mjs workspace/regulate-sigh --skip vo,align,polish` or download the CI artifact). Also merge feature/hook-validation.
