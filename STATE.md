...
## Waiting on Steven
-1. **KEEP/TWEAK/KILL on `animatics/regulate-3am.html` rev2** (rev1 rejected 09-05: not 1:1 with the mock; rev2 is a scaled transcription per new SPEC ruling 11) (branch `feature/regulate-3am`, artifact link in the hivemind STATE). Steven's call 09-05: the 3am video is the first Regulate video; the Sigh is second. Plan + port notes: `animatics/regulate-3am.plan.md`. After KEEP: port needs an `exhale` beat kind (see plan).
